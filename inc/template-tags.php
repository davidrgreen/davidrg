 ...
 */
function davidrg_posts_navigation() {
 ...
 */
function davidrg_post_navigation() {
 ...
 */
function davidrg_archive_title( $before = '', $after = '' ) {
	if ( is_category() ) {
 ...
 */
function davidrg_archive_description( $before = '', $after = '' ) {
